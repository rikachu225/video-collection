/**
 * My Dolls Media Center - Frontend Application
...
async function loadBranding() {
  try {
    ...
    state.siteName = data.siteName || "My Dolls";
    state.theaterName = data.theaterName || "My Sanctuary";
  } catch (e) {
